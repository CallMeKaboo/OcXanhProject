...
const getServices = (req, res) => {
  const q = req.query.service_id
    ? "SELECT service_details.id, service_details.name, service_details.thumbnail, service.start_price,service.description FROM service_details JOIN service ON service.id = service_details.service_id WHERE service_id = ?"
